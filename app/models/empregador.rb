class Empregador < ApplicationRecord
    ...
    validates :nome, presence: { message: "Campo obrigatório" }, length: {minimum: 3, message: "O nome deve ter um tamanho mínimo de 3 caracteres"}
    validates :nomeEmpresa, presence: { message: "Campo obrigatório" }, length: {minimum: 3, message: "O nome da empresa deve ter um tamanho mínimo de 3 caracteres"}
    ...
    validates :endereco, presence: { message: "Campo obrigatório" }, length: {minimum: 5, message: "O endereço deve ter um tamanho mínimo de 5 caracteres"}
