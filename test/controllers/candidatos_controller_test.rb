...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference("Candidato.count") do
      post candidatos_url, params: { candidato: { cpf: @candidato.cpf, dataNascimento: @candidato.dataNascimento, email: @candidato.email, nome: @candidato.nome, telefone: @candidato.telefone } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { cpf: @candidato.cpf, dataNascimento: @candidato.dataNascimento, email: @candidato.email, nome: @candidato.nome, telefone: @candidato.telefone } }
